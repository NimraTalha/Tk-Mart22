                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div className="flex items-center border border-gray-300 rounded-md">
                                <button
                                    className="px-4 py-2 text-yellow-600 hover:bg-pink-50"
                        ...
                        {/* Add to Cart Button */}
                        <button
                            className="w-full bg-yellow-600 text-white py-3 rounded-md hover:bg-yellow-700 transition-colors mb-8"
