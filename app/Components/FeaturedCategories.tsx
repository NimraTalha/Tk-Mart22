        ...
        <div className="w-full h-full bg-yellow-400">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-yellow-50">
                ...
                <div className="relative">
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute -left-4 top-1/2 -translate-y-1/2 bg-white p-2 rounded-full shadow-lg z-10 hover:bg-yellow-50"
                    >
                            ...
                            {getCurrentCategories().map((category: any) => (
                                ...
                                >
                                    <Link href={`/categories/${category.slug?.current}`}>
                                        <div className="relative aspect-square rounded-full overflow-hidden mb-3 border-2 border-yellow-200 group-hover:border-yellow-500 transition-colors">
                                            {category.image && (
                                                <Image
                                    ...
                                    <h3 className="text-center text-sm font-medium text-gray-900 group-hover:text-yellow-600 transition-colors">
                                        {category.name}
                                    </h3>
                                </div>
                            ))}
                    ...
                    <button
                        onClick={nextSlide}
                        className="absolute -right-4 top-1/2 -translate-y-1/2 bg-white p-2 rounded-full shadow-lg z-10 hover:bg-yellow-50"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-yellow-600">
